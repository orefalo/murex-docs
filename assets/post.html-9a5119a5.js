...
post: google.com
</code></pre><p>This enables sane, repeatable and readable defaults. Read the documents on <code>config</code> for more details about it&#39;s usage and the rational behind the command.</p><h2 id="see-also" tabindex="-1"><a class="header-anchor" href="#see-also" aria-hidden="true">#</a> See Also</h2>`,22),h=e("code",null,"[[",-1),p=e("code",null,"[",-1),f=e("code",null,"config",-1),m=e("code",null,"get",-1),g=e("code",null,"getfile",-1);function b(_,q){const a=d("RouterLink");return r(),i("div",null,[u,e("ul",null,[e("li",null,[o(a,{to:"/guide/commands/element.html"},{default:n(()=>[h,t(" (element)")]),_:1}),t(": Outputs an element from a nested structure")]),e("li",null,[o(a,{to:"/guide/commands/"},{default:n(()=>[p,t(" (index)")]),_:1}),t(": Outputs an element from an array, map or table")]),e("li",null,[o(a,{to:"/guide/commands/config.html"},{default:n(()=>[f]),_:1}),t(": Query or define Murex runtime settings")]),e("li",null,[o(a,{to:"/guide/commands/get.html"},{default:n(()=>[m]),_:1}),t(": Makes a standard HTTP request and returns the result as a JSON object")]),e("li",null,[o(a,{to:"/guide/commands/getfile.html"},{default:n(()=>[g]),_:1}),t(": Makes a standard HTTP request and return the contents as Murex-aware data type for passing along Murex pipelines.")])])])}const S=s(l,[["render",b],["__file","post.html.vue"]]);export{S as default};
