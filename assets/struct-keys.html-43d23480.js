...
</code></pre><h2 id="flags" tabindex="-1"><a class="header-anchor" href="#flags" aria-hidden="true">#</a> Flags</h2><ul><li><code>--depth</code> How far to traverse inside the nested structure</li><li><code>--separator</code> String to use as a separator between fields (defaults to <code>/</code>)</li><li><code>-d</code> Alias for \`--depth</li><li><code>-s</code> Alias for \`--separator</li></ul><h2 id="see-also" tabindex="-1"><a class="header-anchor" href="#see-also" aria-hidden="true">#</a> See Also</h2>`,21),i=t("code",null,"[[",-1),p=t("code",null,"[",-1),h=t("code",null,"formap",-1),m=t("code",null,"set",-1);function f(b,N){const o=a("RouterLink");return r(),q("div",null,[c,t("ul",null,[t("li",null,[u(o,{to:"/commands/element.html"},{default:s(()=>[i,e(" (element)")]),_:1}),e(": Outputs an element from a nested structure")]),t("li",null,[u(o,{to:"/commands/"},{default:s(()=>[p,e(" (index)")]),_:1}),e(": Outputs an element from an array, map or table")]),t("li",null,[u(o,{to:"/commands/formap.html"},{default:s(()=>[h]),_:1}),e(": Iterate through a map or other collection of data")]),t("li",null,[u(o,{to:"/commands/set.html"},{default:s(()=>[m]),_:1}),e(": Define a local variable and set it's value")])])])}const _=n(l,[["render",f],["__file","struct-keys.html.vue"]]);export{_ as default};
