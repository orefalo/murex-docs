...
Waking up
5.000240977
</code></pre><h2 id="detail" tabindex="-1"><a class="header-anchor" href="#detail" aria-hidden="true">#</a> Detail</h2><p><code>time</code>&#39;s output is written to STDERR. However any output and errors written by the commands executed by time will also be written to <code>time</code>&#39;s STDOUT and STDERR as usual.</p><h2 id="see-also" tabindex="-1"><a class="header-anchor" href="#see-also" aria-hidden="true">#</a> See Also</h2>`,11),h=e("code",null,"exec",-1),m=e("code",null,"sleep",-1),p=e("code",null,"source",-1);function f(_,x){const t=s("RouterLink");return d(),i("div",null,[u,e("ul",null,[e("li",null,[o(t,{to:"/commands/exec.html"},{default:a(()=>[h]),_:1}),n(": Runs an executable")]),e("li",null,[o(t,{to:"/commands/optional/sleep.html"},{default:a(()=>[m]),_:1}),n(": Suspends the shell for a number of seconds")]),e("li",null,[o(t,{to:"/commands/source.html"},{default:a(()=>[p]),_:1}),n(": Import Murex code from another file of code block")])])])}const k=r(l,[["render",f],["__file","time.html.vue"]]);export{k as default};
