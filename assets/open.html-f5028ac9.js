...
</code></pre><h2 id="see-also" tabindex="-1"><a class="header-anchor" href="#see-also" aria-hidden="true">#</a> See Also</h2>`,27),d=n("code",null,"*",-1),m=n("code",null,"config",-1),q=n("code",null,"exec",-1),h=n("code",null,"fexec",-1),k=n("code",null,"foreach",-1),f=n("code",null,"get",-1),g=n("code",null,"getfile",-1),v=n("code",null,"openagent",-1),b=n("code",null,"out",-1),y=n("code",null,"post",-1);function x(w,T){const t=i("RouterLink");return u(),l("div",null,[r,n("ul",null,[n("li",null,[s(t,{to:"/guide/types/generic.html"},{default:a(()=>[d,e(" (generic) ")]),_:1}),e(": generic (primitive)")]),n("li",null,[s(t,{to:"/guide/commands/config.html"},{default:a(()=>[m]),_:1}),e(": Query or define Murex runtime settings")]),n("li",null,[s(t,{to:"/guide/commands/exec.html"},{default:a(()=>[q]),_:1}),e(": Runs an executable")]),n("li",null,[s(t,{to:"/guide/commands/fexec.html"},{default:a(()=>[h]),_:1}),e(": Execute a command or function, bypassing the usual order of precedence.")]),n("li",null,[s(t,{to:"/guide/commands/foreach.html"},{default:a(()=>[k]),_:1}),e(": Iterate through an array")]),n("li",null,[s(t,{to:"/guide/commands/get.html"},{default:a(()=>[f]),_:1}),e(": Makes a standard HTTP request and returns the result as a JSON object")]),n("li",null,[s(t,{to:"/guide/commands/getfile.html"},{default:a(()=>[g]),_:1}),e(": Makes a standard HTTP request and return the contents as Murex-aware data type for passing along Murex pipelines.")]),n("li",null,[s(t,{to:"/guide/commands/openagent.html"},{default:a(()=>[v]),_:1}),e(": Creates a handler function for `open")]),n("li",null,[s(t,{to:"/guide/commands/out.html"},{default:a(()=>[b]),_:1}),e(": Print a string to the STDOUT with a trailing new line character")]),n("li",null,[s(t,{to:"/guide/commands/post.html"},{default:a(()=>[y]),_:1}),e(": HTTP POST request with a JSON-parsable return")])])])}const M=o(c,[["render",x],["__file","open.html.vue"]]);export{M as default};
