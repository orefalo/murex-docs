...
<span class="token keyword">func</span> <span class="token function">cmdTempFile</span><span class="token punctuation">(</span>p <span class="token operator">*</span>lang<span class="token punctuation">.</span>Process<span class="token punctuation">)</span> <span class="token builtin">error</span> <span class="token punctuation">{</span>
	...
	<span class="token keyword">return</span> err
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>This should should provide enough distance to run <code>tmp</code> in parallel....should you ever want to.</p><p><code>tmp</code> files are also located inside a unique per-process Murex temp directory which itself is located in the appropriate temp directory for the host OS (eg <code>$TMPDIR</code> on macOS).</p><h2 id="see-also" tabindex="-1"><a class="header-anchor" href="#see-also" aria-hidden="true">#</a> See Also</h2>`,15),d=n("code",null,">>",-1),k=n("code",null,">",-1),m=n("code",null,"open",-1),v=n("code",null,"pipe",-1);function h(b,f){const a=p("RouterLink");return c(),i("div",null,[r,n("ul",null,[n("li",null,[t(a,{to:"/guide/commands/greater-than-greater-than.html"},{default:e(()=>[d,s(" (append file)")]),_:1}),s(": Writes STDIN to disk - appending contents if file already exists")]),n("li",null,[t(a,{to:"/guide/commands/greater-than.html"},{default:e(()=>[k,s(" (truncate file)")]),_:1}),s(": Writes STDIN to disk - overwriting contents if file already exists")]),n("li",null,[t(a,{to:"/guide/commands/open.html"},{default:e(()=>[m]),_:1}),s(": Open a file with a preferred handler")]),n("li",null,[t(a,{to:"/guide/commands/pipe.html"},{default:e(()=>[v]),_:1}),s(": Manage Murex named pipes")])])])}const y=o(u,[["render",h],["__file","tmp.html.vue"]]);export{y as default};
