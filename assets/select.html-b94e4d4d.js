...
</code></pre><p>(See below for how to use <code>config</code>)</p><h3 id="read-all-vs-sequential-reads" tabindex="-1"><a class="header-anchor" href="#read-all-vs-sequential-reads" aria-hidden="true">#</a> Read All vs Sequential Reads</h3><p>At present, <code>select</code> only supports reading the entire table from STDIN before importing that data into sqlite3. There is some prototype code being written to support sequential imports but this is hugely experimental and not yet enabled.</p><p>This might make <code>select</code> unsuitable for large datasets.</p><h3 id="early-release" tabindex="-1"><a class="header-anchor" href="#early-release" aria-hidden="true">#</a> Early Release</h3><p>This is a very early release so there almost certainly will be bugs hiding. Which is another reason why this is currently only an optional builtin.</p>`,21),p={href:"https://github.com/lmorg/murex/issues",target:"_blank",rel:"noopener noreferrer"},f=e("h2",{id:"synonyms",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#synonyms","aria-hidden":"true"},"#"),t(" Synonyms")],-1),m=e("ul",null,[e("li",null,[e("code",null,"select")])],-1),q=e("h2",{id:"see-also",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#see-also","aria-hidden":"true"},"#"),t(" See Also")],-1),g=e("code",null,"*",-1),_=e("code",null,"config",-1),b=e("code",null,"csv",-1),y=e("code",null,"jsonl",-1),x=e("code",null,"config",-1);function D(v,w){const s=i("ExternalLinkIcon"),n=i("RouterLink");return r(),u("div",null,[h,e("p",null,[t("If you do run into any issues then please raise them on "),e("a",p,[t("Github"),o(s)]),t(".")]),f,m,q,e("ul",null,[e("li",null,[o(n,{to:"/guide/types/generic.html"},{default:a(()=>[g,t(" (generic) ")]),_:1}),t(": generic (primitive)")]),e("li",null,[o(n,{to:"/guide/commands/config.html"},{default:a(()=>[_]),_:1}),t(": Query or define Murex runtime settings")]),e("li",null,[o(n,{to:"/guide/types/csv.html"},{default:a(()=>[b]),_:1}),t(": CSV files (and other character delimited tables)")]),e("li",null,[o(n,{to:"/guide/types/jsonl.html"},{default:a(()=>[y]),_:1}),t(": JSON Lines")]),e("li",null,[o(n,{to:"/guide/changelog/v2.1.html"},{default:a(()=>[t("v2.1")]),_:1}),t(": This release comes with support for inlining SQL and some major bug fixes plus a breaking change for "),x,t(". Please read for details.")])])])}const k=l(c,[["render",D],["__file","select.html.vue"]]);export{k as default};
