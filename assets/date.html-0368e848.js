...
Thursday, 02 January
Friday, 03 January
</code></pre><h2 id="see-also" tabindex="-1"><a class="header-anchor" href="#see-also" aria-hidden="true">#</a> See Also</h2>`,30),m=n("code",null,"[[",-1),h=n("code",null,"[",-1),v=n("code",null,"[",-1),g=n("code",null,"a",-1),k=n("code",null,"count",-1),b=n("code",null,"datetime",-1),y=n("code",null,"printf",-1),q=n("code",null,"ja",-1),f=n("code",null,"mtac",-1),J=n("code",null,"ta",-1);function _(D,x){const e=r("RouterLink");return d(),l("div",null,[u,n("p",null,[a("Please refer to "),s(e,{to:"/guide/commands/a.html"},{default:t(()=>[a("a (mkarray)")]),_:1}),a(" for more detailed usage of mkarray.")]),p,n("ul",null,[n("li",null,[s(e,{to:"/guide/mkarray/special.html"},{default:t(()=>[a("Special Ranges")]),_:1}),a(": Create arrays from ranges of dictionary terms (eg weekdays, months, seasons, etc)")]),n("li",null,[s(e,{to:"/guide/commands/element.html"},{default:t(()=>[m,a(" (element)")]),_:1}),a(": Outputs an element from a nested structure")]),n("li",null,[s(e,{to:"/guide/commands/"},{default:t(()=>[h,a(" (index)")]),_:1}),a(": Outputs an element from an array, map or table")]),n("li",null,[s(e,{to:"/guide/commands/range.html"},{default:t(()=>[v,a(" (range) ")]),_:1}),a(": Outputs a ranged subset of data from STDIN")]),n("li",null,[s(e,{to:"/guide/commands/a.html"},{default:t(()=>[g,a(" (mkarray)")]),_:1}),a(": A sophisticated yet simple way to build an array or list")]),n("li",null,[s(e,{to:"/guide/commands/count.html"},{default:t(()=>[k]),_:1}),a(": Count items in a map, list or array")]),n("li",null,[s(e,{to:"/guide/commands/datetime.html"},{default:t(()=>[b]),_:1}),a(": A date and/or time conversion tool (like "),y,a(" but for date and time values)")]),n("li",null,[s(e,{to:"/guide/commands/ja.html"},{default:t(()=>[q,a(" (mkarray)")]),_:1}),a(": A sophisticated yet simply way to build a JSON array")]),n("li",null,[s(e,{to:"/guide/commands/mtac.html"},{default:t(()=>[f]),_:1}),a(": Reverse the order of an array")]),n("li",null,[s(e,{to:"/guide/commands/ta.html"},{default:t(()=>[J,a(" (mkarray)")]),_:1}),a(": A sophisticated yet simple way to build an array of a user defined data-type")])])])}const N=i(c,[["render",_],["__file","date.html.vue"]]);export{N as default};
