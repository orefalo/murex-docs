import{_ as s}from"./plugin-vue_export-helper-c27b6911.js";import{r,o as c,c as l,a as e,b as o,d as a,w as n,e as i}from"./app-66ffa3c3.js";const u={},h=i('<h1 id="let-command-reference" tabindex="-1"><a class="header-anchor" href="#let-command-reference" aria-hidden="true">#</a> <code>let</code> - Command Reference</h1><blockquote><p>Evaluate a mathematical function and assign to variable (deprecated)</p></blockquote><h2 id="description" tabindex="-1"><a class="header-anchor" href="#description" aria-hidden="true">#</a> Description</h2><p><code>let</code> evaluates a mathematical function and then assigns it to a locally scoped variable (like <code>set</code>)</p>',4),p=e("code",null,"expr",-1),b=i(`<h2 id="usage" tabindex="-1"><a class="header-anchor" href="#usage" aria-hidden="true">#</a> Usage</h2><pre><code>let var_name=evaluation
...
» = \`foo\`+\`bar\`
foobar
</code></pre><h3 id="read-more" tabindex="-1"><a class="header-anchor" href="#read-more" aria-hidden="true">#</a> Read more</h3>`,38),m={href:"https://github.com/Knetic/govaluate",target:"_blank",rel:"noopener noreferrer"},f=i(`<h3 id="type-annotations" tabindex="-1"><a class="header-anchor" href="#type-annotations" aria-hidden="true">#</a> Type Annotations</h3><p>When <code>set</code> or <code>global</code> are used as a function, the parameters are passed as a string which means the variables are defined as a <code>str</code>. If you wish to define them as an alternate data type then you should add type annotations:</p><pre><code>» set: int age = 30
...
» out %($foo)
bar
</code></pre><h2 id="see-also" tabindex="-1"><a class="header-anchor" href="#see-also" aria-hidden="true">#</a> See Also</h2>`,44),g=e("code",null,"(",-1),v=e("code",null,"=",-1),y=e("code",null,"[[",-1),x=e("code",null,"[",-1),w=e("code",null,"export",-1),_=e("code",null,"expr",-1),k=e("code",null,"global",-1),q=e("code",null,"if",-1),$=e("code",null,"set",-1);function V(A,T){const t=r("RouterLink"),d=r("ExternalLinkIcon");return c(),l("div",null,[h,e("p",null,[e("strong",null,[o("This is a deprecated feature. Please refer to "),a(t,{to:"/guide/commands/expr.html"},{default:n(()=>[p]),_:1}),o(" instead.")])]),b,e("p",null,[o("Murex uses the "),e("a",m,[o("govaluate package"),a(d)]),o(". More information can be found in it's manual.")]),f,e("ul",null,[e("li",null,[a(t,{to:"/guide/user-guide/reserved-vars.html"},{default:n(()=>[o("Reserved Variables")]),_:1}),o(": Special variables reserved by Murex")]),e("li",null,[a(t,{to:"/guide/user-guide/scoping.html"},{default:n(()=>[o("Variable and Config Scoping")]),_:1}),o(": How scoping works within Murex")]),e("li",null,[a(t,{to:"/guide/commands/brace-quote.html"},{default:n(()=>[g,o(" (brace quote)")]),_:1}),o(": Write a string to the STDOUT without new line")]),e("li",null,[a(t,{to:"/guide/commands/equ.html"},{default:n(()=>[v,o(" (arithmetic evaluation)")]),_:1}),o(": Evaluate a mathematical function (deprecated)")]),e("li",null,[a(t,{to:"/guide/commands/element.html"},{default:n(()=>[y,o(" (element)")]),_:1}),o(": Outputs an element from a nested structure")]),e("li",null,[a(t,{to:"/guide/commands/"},{default:n(()=>[x,o(" (index)")]),_:1}),o(": Outputs an element from an array, map or table")]),e("li",null,[a(t,{to:"/guide/commands/export.html"},{default:n(()=>[w]),_:1}),o(": Define an environmental variable and set it's value")]),e("li",null,[a(t,{to:"/guide/commands/expr.html"},{default:n(()=>[_]),_:1}),o(": Expressions: mathematical, string comparisons, logical operators")]),e("li",null,[a(t,{to:"/guide/commands/global.html"},{default:n(()=>[k]),_:1}),o(": Define a global variable and set it's value")]),e("li",null,[a(t,{to:"/guide/commands/if.html"},{default:n(()=>[q]),_:1}),o(": Conditional statement to execute different blocks of code depending on the result of the condition")]),e("li",null,[a(t,{to:"/guide/commands/set.html"},{default:n(()=>[$]),_:1}),o(": Define a local variable and set it's value")])])])}const N=s(u,[["render",V],["__file","let.html.vue"]]);export{N as default};
