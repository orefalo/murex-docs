import{_ as s}from"./plugin-vue_export-helper-c27b6911.js";import{r as u,o as r,c as d,a as t,b as e,d as o,w as n,e as l}from"./app-66ffa3c3.js";const c={},q=l('<h1 id="json-data-type-reference" tabindex="-1"><a class="header-anchor" href="#json-data-type-reference" aria-hidden="true">#</a> <code>json</code> - Data-Type Reference</h1><blockquote><p>JavaScript Object Notation (JSON)</p></blockquote><h2 id="description" tabindex="-1"><a class="header-anchor" href="#description" aria-hidden="true">#</a> Description</h2><p>JSON is a structured data-type within Murex. It is the standard format for all structured data within Murex however other formats such as YAML, TOML and CSV are equally first class citizens.</p><h2 id="examples" tabindex="-1"><a class="header-anchor" href="#examples" aria-hidden="true">#</a> Examples</h2>',5),h={href:"https://en.wikipedia.org/wiki/JSON",target:"_blank",rel:"noopener noreferrer"},p=l(`<pre><code>{
  &quot;firstName&quot;: &quot;John&quot;,
  &quot;lastName&quot;: &quot;Smith&quot;,
  &quot;isAlive&quot;: true,
  &quot;age&quot;: 27,
...
</code></pre><h2 id="default-associations" tabindex="-1"><a class="header-anchor" href="#default-associations" aria-hidden="true">#</a> Default Associations</h2><ul><li><strong>Extension</strong>: <code>json</code></li><li><strong>MIME</strong>: <code>application/json</code></li><li><strong>MIME</strong>: <code>application/x-json</code></li><li><strong>MIME</strong>: <code>text/json</code></li><li><strong>MIME</strong>: <code>text/x-json</code></li></ul><h2 id="supported-hooks" tabindex="-1"><a class="header-anchor" href="#supported-hooks" aria-hidden="true">#</a> Supported Hooks</h2><ul><li><code>Marshal()</code> Writes minified JSON when no TTY detected and human readable JSON when stdout is a TTY</li><li><code>ReadArray()</code> Works with JSON arrays. Maps are converted into arrays</li><li><code>ReadArrayWithType()</code> Works with JSON arrays. Maps are converted into arrays. Elements data-type in Murex mirrors the JSON type of the element</li><li><code>ReadIndex()</code> Works against all properties in JSON</li><li><code>ReadMap()</code> Works with JSON maps</li><li><code>ReadNotIndex()</code> Works against all properties in JSON</li><li><code>Unmarshal()</code> Supported</li><li><code>WriteArray()</code> Works with JSON arrays</li></ul><h2 id="see-also" tabindex="-1"><a class="header-anchor" href="#see-also" aria-hidden="true">#</a> See Also</h2>`,21),m=t("code",null,"Marshal()",-1),f=t("code",null,"ReadArray()",-1),y=t("code",null,"ReadArrayWithType()",-1),g=t("code",null,"ReadIndex()",-1),_=t("code",null,"[",-1),b=t("code",null,"ReadMap()",-1),x=t("code",null,"ReadNotIndex()",-1),S=t("code",null,"![",-1),w=t("code",null,"Unmarshal()",-1),N=t("code",null,"WriteArray()",-1),j=t("code",null,"[[",-1),D=t("code",null,"[",-1),k=t("code",null,"cast",-1),O=t("code",null,"format",-1),T=t("code",null,"hcl",-1),M=t("code",null,"jsonc",-1),v=t("code",null,"jsonl",-1),J=t("code",null,"lang.ArrayTemplate()",-1),A=t("code",null,"lang.ArrayWithTypeTemplate()",-1),R=t("code",null,"open",-1),I=t("code",null,"pretty",-1),W=t("code",null,"runtime",-1),L=t("code",null,"toml",-1),$=t("code",null,"yaml",-1);function B(H,E){const i=u("ExternalLinkIcon"),a=u("RouterLink");return r(),d("div",null,[q,t("p",null,[e("Example JSON document taken from "),t("a",h,[e("Wikipedia"),o(i)])]),p,t("ul",null,[t("li",null,[o(a,{to:"/guide/apis/Marshal.html"},{default:n(()=>[m,e(" (type)")]),_:1}),e(": Converts structured memory into a structured file format (eg for stdio)")]),t("li",null,[o(a,{to:"/guide/apis/ReadArray.html"},{default:n(()=>[f,e(" (type)")]),_:1}),e(": Read from a data type one array element at a time")]),t("li",null,[o(a,{to:"/guide/apis/ReadArrayWithType.html"},{default:n(()=>[y,e(" (type)")]),_:1}),e(": Read from a data type one array element at a time and return the elements contents and data type")]),t("li",null,[o(a,{to:"/guide/apis/ReadIndex.html"},{default:n(()=>[g,e(" (type)")]),_:1}),e(": Data type handler for the index, "),_,e(", builtin")]),t("li",null,[o(a,{to:"/guide/apis/ReadMap.html"},{default:n(()=>[b,e(" (type)")]),_:1}),e(": Treat data type as a key/value structure and read its contents")]),t("li",null,[o(a,{to:"/guide/apis/ReadNotIndex.html"},{default:n(()=>[x,e(" (type)")]),_:1}),e(": Data type handler for the bang-prefixed index, "),S,e(", builtin")]),t("li",null,[o(a,{to:"/guide/apis/Unmarshal.html"},{default:n(()=>[w,e(" (type)")]),_:1}),e(": Converts a structured file format into structured memory")]),t("li",null,[o(a,{to:"/guide/apis/WriteArray.html"},{default:n(()=>[N,e(" (type)")]),_:1}),e(": Write a data type, one array element at a time")]),t("li",null,[o(a,{to:"/guide/commands/element.html"},{default:n(()=>[j,e(" (element)")]),_:1}),e(": Outputs an element from a nested structure")]),t("li",null,[o(a,{to:"/guide/commands/"},{default:n(()=>[D,e(" (index)")]),_:1}),e(": Outputs an element from an array, map or table")]),t("li",null,[o(a,{to:"/guide/commands/cast.html"},{default:n(()=>[k]),_:1}),e(": Alters the data type of the previous function without altering it's output")]),t("li",null,[o(a,{to:"/guide/commands/format.html"},{default:n(()=>[O]),_:1}),e(": Reformat one data-type into another data-type")]),t("li",null,[o(a,{to:"/guide/types/hcl.html"},{default:n(()=>[T]),_:1}),e(": HashiCorp Configuration Language (HCL)")]),t("li",null,[o(a,{to:"/guide/types/jsonc.html"},{default:n(()=>[M]),_:1}),e(": Concatenated JSON")]),t("li",null,[o(a,{to:"/guide/types/jsonl.html"},{default:n(()=>[v]),_:1}),e(": JSON Lines")]),t("li",null,[o(a,{to:"/guide/apis/lang.ArrayTemplate.html"},{default:n(()=>[J,e(" (template API)")]),_:1}),e(": Unmarshals a data type into a Go struct and returns the results as an array")]),t("li",null,[o(a,{to:"/guide/apis/lang.ArrayWithTypeTemplate.html"},{default:n(()=>[A,e(" (template API)")]),_:1}),e(": Unmarshals a data type into a Go struct and returns the results as an array with data type included")]),t("li",null,[o(a,{to:"/guide/commands/open.html"},{default:n(()=>[R]),_:1}),e(": Open a file with a preferred handler")]),t("li",null,[o(a,{to:"/guide/commands/pretty.html"},{default:n(()=>[I]),_:1}),e(": Prettifies JSON to make it human readable")]),t("li",null,[o(a,{to:"/guide/commands/runtime.html"},{default:n(()=>[W]),_:1}),e(": Returns runtime information on the internal state of Murex")]),t("li",null,[o(a,{to:"/guide/types/toml.html"},{default:n(()=>[L]),_:1}),e(": Tom's Obvious, Minimal Language (TOML)")]),t("li",null,[o(a,{to:"/guide/types/yaml.html"},{default:n(()=>[$]),_:1}),e(": YAML Ain't Markup Language (YAML)")]),t("li",null,[o(a,{to:"/guide/types/mxjson.html"},{default:n(()=>[e("mxjson")]),_:1}),e(": Murex-flavoured JSON (deprecated)")])])])}const C=s(c,[["render",B],["__file","json.html.vue"]]);export{C as default};
