...
</code></pre><h2 id="see-also" tabindex="-1"><a class="header-anchor" href="#see-also" aria-hidden="true">#</a> See Also</h2>`,10);function h(g,m){const n=r("RouterLink");return s(),o("div",null,[c,e("ul",null,[e("li",null,[i(n,{to:"/guide/user-guide/reserved-vars.html"},{default:l(()=>[a("Reserved Variables")]),_:1}),a(": Special variables reserved by Murex")])])])}const b=t(d,[["render",h],["__file","args.html.vue"]]);export{b as default};
