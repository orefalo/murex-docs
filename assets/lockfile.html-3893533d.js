...
out: &quot;lock file gone!&quot;
</code></pre><h2 id="see-also" tabindex="-1"><a class="header-anchor" href="#see-also" aria-hidden="true">#</a> See Also</h2>`,16),f=e("code",null,"bg",-1),p=e("code",null,"out",-1);function u(m,k){const o=c("RouterLink");return n(),d("div",null,[h,e("ul",null,[e("li",null,[t(o,{to:"/guide/commands/bg.html"},{default:a(()=>[f]),_:1}),i(": Run processes in the background")]),e("li",null,[t(o,{to:"/guide/commands/out.html"},{default:a(()=>[p]),_:1}),i(": Print a string to the STDOUT with a trailing new line character")])])])}const x=l(s,[["render",u],["__file","lockfile.html.vue"]]);export{x as default};
