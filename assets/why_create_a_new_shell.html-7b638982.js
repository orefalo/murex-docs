...
</code></pre><p>Thus <code>$.val</code> (eg <strong>2</strong>) would be compared to the number <strong>2</strong>. If the result is true, that element is output. If the result is false then that element is ignored.</p><h2 id="conclusion" tabindex="-1"><a class="header-anchor" href="#conclusion" aria-hidden="true">#</a> Conclusion</h2><p>There are a multitude of ways to iterate through structured data on Linux and UNIX systems.</p><hr><p>Published: 06.05.2021 at 08:24</p><h2 id="see-also" tabindex="-1"><a class="header-anchor" href="#see-also" aria-hidden="true">#</a> See Also</h2>`,22),m=e("code",null,"%[]",-1),f=e("code",null,"cast",-1),b=e("code",null,"foreach",-1),y=e("code",null,"formap",-1);function q(w,g){const o=s("RouterLink");return l(),u("div",null,[d,c,p,e("ul",null,[e("li",null,[a(o,{to:"/parser/create-array.html"},{default:r(()=>[t("Create array ("),m,t(") constructor")]),_:1}),t(": Quickly generate arrays")]),e("li",null,[a(o,{to:"/commands/cast.html"},{default:r(()=>[f]),_:1}),t(": Alters the data type of the previous function without altering it's output")]),e("li",null,[a(o,{to:"/commands/foreach.html"},{default:r(()=>[b]),_:1}),t(": Iterate through an array")]),e("li",null,[a(o,{to:"/commands/formap.html"},{default:r(()=>[y]),_:1}),t(": Iterate through a map or other collection of data")]),e("li",null,[a(o,{to:"/commands/mkarray/"},{default:r(()=>[t("mkarray")]),_:1}),t(":")])])])}const k=i(h,[["render",q],["__file","why_create_a_new_shell.html.vue"]]);export{k as default};
