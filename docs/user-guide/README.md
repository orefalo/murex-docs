...
The [Language Tour](/tour) is a great introduction into the Murex language.

## User Guides

- [ANSI Constants](./ansi.md):
  Infixed constants that return ANSI escape sequences
- [Bang Prefix](./bang-prefix.md):
  Bang prefixing to reverse default actions
- [Code Block Parsing](./code-block.md):
  Overview of how code blocks are parsed
- [FileRef](./fileref.md):
  How to track what code was loaded and from where
- [Modules and Packages](./modules.md):
  An introduction to Murex modules and packages
- [Murex Named Pipes](./namedpipes.md):
  A detailed breakdown of named pipes in Murex
- [Murex Profile Files](./profile.md):
  A breakdown of the different files loaded on start up
- [Murex's Interactive Shell](./interactive-shell.md):
  What's different about Murex's interactive shell?
- [Pipeline](./pipeline.md):
  Overview of what a "pipeline" is
- [Reserved Variables](./reserved-vars.md):
...
- [Terminal Hotkeys](./terminal-keys.md):
  A list of all the terminal hotkeys and their uses
- [Variable and Config Scoping](./scoping.md):
