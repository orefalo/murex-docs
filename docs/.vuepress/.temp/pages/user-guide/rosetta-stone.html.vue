<template><div><h1 id="rosetta-stone-user-guide" tabindex="-1"><a class="header-anchor" href="#rosetta-stone-user-guide" aria-hidden="true">#</a> Rosetta Stone - User Guide</h1>
<blockquote>
<p>A tabulated list of Bashism's and their equivalent Murex syntax</p>
</blockquote>
<p>Below is a reference table of common Bash code and how it could be written in<br>
Murex.</p>
<p>It is also recommended that you read the language <RouterLink to="/tour.html">tour</RouterLink><br>
...
<tr>
<td><RouterLink to="/user-guide/commands/err.html">Write to STDERR</RouterLink></td>
...
<li><RouterLink to="/user-guide/namedpipes.html">Murex Named Pipes</RouterLink>:<br>
