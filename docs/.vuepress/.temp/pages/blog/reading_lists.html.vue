...
<li><a href="#reading-lines-in-bash-and-similar-shells">Reading lines in Bash and similar shells</a></li>
<li><a href="#but-what-if-my-files-arent-line-delimited">But what if my files aren't line delimited?</a></li>
<li><a href="#iteration-in-bash-via-jq">Iteration in Bash via <code v-pre>jq</code></a></li>
<li><a href="#iteration-in-murex-via-foreach">Iteration in Murex via <code v-pre>foreach</code></a></li>
<li><a href="#reading-json-arrays-in-powershell">Reading JSON arrays in PowerShell</a></li>
...
<ul>
<li><RouterLink to="/parser/create-array.html">Create array (<code v-pre>%[]</code>) constructor</RouterLink>:<br>
...
<li><RouterLink to="/commands/cast.html"><code v-pre>cast</code></RouterLink>:<br>
