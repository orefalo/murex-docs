...
<li><RouterLink to="/commands/autoglob.html"><code v-pre>@g</code> (autoglob) </RouterLink>:<br>
...
<li><RouterLink to="/commands/read.html"><code v-pre>read</code></RouterLink>:<br>
